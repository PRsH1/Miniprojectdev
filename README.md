...
| Params 탭 | Path / Query Parameter 입력, URL 실시간 반영 |
| Headers 탭 | 헤더 추가/수정, API별 필수 헤더 자동 노출 |
| Body 탭 | JSON 에디터, 높이 드래그 조절로 자동 확장 (DELETE 메서드 포함) |
...
| 문서 | OPA2_003~009, 014, 016, 021, 040, 042, 045 | OPA2_003~009, 014 성공+실패 완비 |
| 템플릿 | OPA2_015 작성 가능한 템플릿 목록 | 실패(공통) |
| 멤버 | OPA2_010~013, 030 | OPA2_010~013 성공+실패 완비 |
| 그룹 | OPA2_017~020 | 실패(공통) |
| 회사 | OPA2_025, 029, 037 | 실패(공통) |
