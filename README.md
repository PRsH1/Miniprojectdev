...
| Body 탭 | JSON 에디터, 높이 드래그 조절로 자동 확장 |
| Response 뷰어 | 상태 코드 배지, JSON 문법 강조, 엔드포인트별 결과 캐싱 |
| 예시 응답 | 성공/실패 응답 구조 미리보기 (타입 표현) |

### 등록된 API (OPA2_XXX)

| 그룹 | API 목록 |
|------|---------|
| 인증 | OPA2_001 Access Token 발급, OPA2_002 Access Token 갱신 |
| 문서 | OPA2_003~009, 014, 016, 021, 040, 042, 045 |
| 템플릿 | OPA2_015 작성 가능한 템플릿 목록 |
| 멤버 | OPA2_010~013, 030 |
| 그룹 | OPA2_017~020 |
| 회사 | OPA2_025, 029, 037 |
